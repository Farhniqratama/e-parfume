		...
		<div class="modal-content modal-sm"> 
			...
			<div class="modal-body" style="text-align: center;">
				...
				<div class="swal2-actions">
					<a href="{{ URL::to('delete-banner/'.$values->id) }}" type="button" class="btn btn-success" aria-label="" style="display: inline-block; border-left-color: rgb(30, 224, 172) !important; border-right-color: rgb(30, 224, 172) !important;">Yes, delete it!</a>
